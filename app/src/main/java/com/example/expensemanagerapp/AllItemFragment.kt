...
import com.example.expensemanagerapp.Adapter.AllAdapter
import com.example.expensemanagerapp.Database.database
...
class AllItemFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       database = Room.databaseBuilder(requireContext(), database::class.java, "my-database").build()
